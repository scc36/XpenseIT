...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    MenuViewController *rootView = (MenuViewController *)self.window.rootViewController;
    rootView.managedObjectContext = self.managedObjectContext;
    
    // For now, add a default configuration account
    /* ##Later
    // Logic to handle first time users
    */
    ...
    if ([prefs boolForKey:@"hasInitialized"] != YES)
    {
        ...
        if (![self.managedObjectContext save:&error])
            NSLog(@"Failed to add default configuration - error: %@", [error domain]);
        
        // Set initialize flag after first time setup is complete
        //might want to move to after successful setup
        [prefs setBool:YES forKey:@"hasInitialized"];
        [prefs synchronize];
    }
...
- (NSManagedObjectModel *)managedObjectModel
{
    ...
    NSURL *modelURL = [[NSBundle mainBundle] URLForResource:@"XpenseIT" withExtension:@"momd"];
...
- (NSPersistentStoreCoordinator *)persistentStoreCoordinator
{
    ...
    NSURL *storeURL = [[self applicationDocumentsDirectory] URLByAppendingPathComponent:@"XpenseIT.sqlite"];
